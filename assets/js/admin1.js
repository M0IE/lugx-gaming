function addFormEventHandlers() {
 ...
 function loadUsers() {
    fetch('./php/admin_actions.php?action=get_users')
 ...
 function loadOrders() {
    fetch('./php/admin_actions.php?action=get_orders')
        .then(response => response.json())
        .then(orders => {
 ...
 function saveGame() {
    ...
    fetch('./php/admin_actions.php?action=save_game', {
        method: 'POST',
        body: formData
    })
    .then(response => response.json())
 ...
 function saveUser() {
    ...
    fetch('./php/admin_actions.php?action=save_user', {
        method: 'POST',
        body: formData
    })
    .then(response => response.json())
 ...
 function saveSettings() {
    ...
    fetch('./php/admin_actions.php?action=save_settings', {
        method: 'POST',
        body: formData
    })
    .then(response => response.json())
 ...
 function editGame(gameId) {
    fetch('./php/admin_actions.php?action=get_game&id=' + gameId)
        .then(response => response.json())
        .then(game => {
 ...
 function deleteGame(gameId) {
    if (confirm('¿Estás seguro de que deseas eliminar este juego?')) {
        fetch('./php/admin_actions.php?action=delete_game', {
            method: 'POST',
            headers: {
 ...
 function editUser(userId) {
    fetch('./php/admin_actions.php?action=get_user&id=' + userId)
        .then(response => response.json())
        .then(user => {
 ...
 function deleteUser(userId) {
    if (confirm('¿Estás seguro de que deseas eliminar este usuario?')) {
        fetch('./php/admin_actions.php?action=delete_user', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
 ...
 function viewOrder(orderId) {
    fetch('./php/admin_actions.php?action=get_order&id=' + orderId)
        .then(response => response.json())
        .then(order => {
 ...
 function updateOrderStatus(orderId, status) {
    fetch('./php/admin_actions.php?action=update_order_status', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
function loadRecentOrders() {
    fetch('./php/admin_actions.php?action=get_recent_orders')
        .then(response => response.json())
        .then(orders => {
...
function loadRecentActivity() {
    fetch('./php/admin_actions.php?action=get_recent_activity')
        .then(response => response.json())
        .then(activities => {
