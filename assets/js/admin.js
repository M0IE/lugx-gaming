...
function initializeSalesChart() {
    fetch('./get_stats.php?type=monthly')
        .then(response => {
            if (!response.ok) {
 ...
 function initializeTopGamesChart() {
    fetch('./get_stats.php?type=top_games')
        .then(response => {
            if (!response.ok) {
                throw new Error('Network response was not ok');
            }
 ...
 function loadDashboardStats() {
    fetch('./get_stats.php?type=dashboard')
        .then(response => {
            if (!response.ok) {
                throw new Error('Network response was not ok');
            }
 ...
 function loadGames() {
    fetch('./admin_actions.php?action=get_games')
        .then(response => {
            if (!response.ok) {
                throw new Error('Network response was not ok');
            }
 ...
 function loadOrders() {
    fetch('./admin_actions.php?action=get_orders')
        .then(response => response.json())
        .then(orders => {
 ...
 function saveGame() {
    ...
    fetch('./admin_actions.php?action=save_game', {
        method: 'POST',
        body: formData
    })
    .then(response => response.json())
 ...
 function saveUser() {
    ...
    fetch('./admin_actions.php?action=save_user', {
        method: 'POST',
        body: formData
    })
    .then(response => response.json())
 ...
 function saveSettings() {
    ...
    fetch('./admin_actions.php?action=save_settings', {
        method: 'POST',
        body: formData
    })
    .then(response => response.json())
 ...
 function editGame(gameId) {
    fetch('./admin_actions.php?action=get_game&id=' + gameId)
        .then(response => response.json())
        .then(game => {
 ...
 function deleteGame(gameId) {
    if (confirm('¿Estás seguro de que deseas eliminar este juego?')) {
        fetch('./admin_actions.php?action=delete_game', {
            method: 'POST',
            headers: {
 ...
 function editUser(userId) {
    fetch('./admin_actions.php?action=get_user&id=' + userId)
        .then(response => response.json())
        .then(user => {
 ...
 function viewOrder(orderId) {
    fetch('./admin_actions.php?action=get_order&id=' + orderId)
        .then(response => response.json())
        .then(order => {
...
function loadRecentOrders() {
    fetch('./admin_actions.php?action=get_recent_orders')
        .then(response => response.json())
        .then(orders => {
...
function loadRecentActivity() {
    fetch('./admin_actions.php?action=get_recent_activity')
        .then(response => response.json())
        .then(activities => {
